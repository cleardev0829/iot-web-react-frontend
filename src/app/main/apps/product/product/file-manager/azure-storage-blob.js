...
const sasToken =
	...
	'sv=2020-08-04&ss=b&srt=sco&sp=rwdlacx&se=2021-09-12T00:48:18Z&st=2021-08-27T16:48:18Z&spr=https&sig=8nrpbq1qnC40HSopC0cAl65ZeF6PctBZqIuxFwnc4CU%3D'; // Fill string with your SAS token
const containerName = `rocket-iot-files`;
const storageAccountName = process.env.storageresourcename || 'rocketiotparserstorage'; // Fill string with your Storage resource name
// </snippet_package>
